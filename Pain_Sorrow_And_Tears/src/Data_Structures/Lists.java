...
public class Lists {
    ...
    private final String[] increaseElements;
    private final String[] newElements;
    private int indexOfElement;
    public Lists (int sizeOfList){
        indexOfElement = sizeOfList;
        elements = new String[indexOfElement];
        newElements = new String[sizeOfList - 1];
        increaseElements = new String[elements.length + 1];
    }
    ...
    public void add(String element){
        ...
        numberOfAdds++;
        isEmpty = false;
        if (numberOfAdds == indexOfElement){increaseElements[numberOfAdds]=element;}
    }
    ...
    public String get(int index) {
        if (numberOfAdds > indexOfElement) return increaseElements[index];
    ...
    public boolean contains(String element) {
        String[] newArray;
        newArray = elements;
        for (String array : newArray) {return array.equals(element);}
        return false;
    }
}
